...
/// A widget that displays the Apple logo as an SVG icon within a button.
class AppleIconMiniButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SvgIconButton(
        svgVectorPath: ImagePaths.appleLogoIcon,
        onPressed: onPressed,
        style: style,
